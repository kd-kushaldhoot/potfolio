...
// TYPEWRITER
const phrases = ["QR Entry / Exit System is your Java project.", "Java desktop apps and secure systems live here.", "Good Java code, clean UI, real functionality."];
